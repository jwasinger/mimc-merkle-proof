  ...
  (func $g1m_double (export "g1m_double")  (param $p0 i32) (param $p1 i32)
    ...
    (call $f1m_add
      ...
      (i32.add
        (local.get $p1)
        (i32.const 64))))
  (func $websnark_bn128/bn128_g1m_add (export "g1m_add")  (param $p0 i32) (param $p1 i32) (param $p2 i32)
  ...
  (func $websnark_bn128/bn128_g1m_toMontgomery (export "g1m_toMontgomery")  (param $p0 i32) (param $p1 i32)
    ...
    (call $f1m_toMontgomery
      ...
      (i32.add
        (local.get $p1)
        (i32.const 64))))
  (func $websnark_bn128/bn128_g1m_affine (export "g1m_affine")  (param $p0 i32) (param $p1 i32)
    (if $I0
      (call $g1m_isZero
        (local.get $p0))
      (then
      ...
      (else
        ...
        (call $f1m_one
          (i32.add
            (local.get $p1)
            (i32.const 64))))))
  (func $websnark_bn128/bn128_g1m_timesScalar (export "g1m_timesScalar")  (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32)
    (local $l4 i32) (local $l5 i32)
    (call $g1m_copy
      (local.get $p0)
      (i32.const 4360))
  ...
  (func $bn128_pairingEq3 (export "bn128_pairingEq3")  (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32) (param $p4 i32) (param $p5 i32) (param $p6 i32) (result i32)
    ...
    (call $ftm_eq
      (i32.const 205936)
      (local.get $p6)))
  (func $websnark_bn128/bn128_pairingEq4 (export "bn128_pairingEq4")  (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32) (param $p4 i32) (param $p5 i32) (param $p6 i32) (param $p7 i32) (param $p8 i32) (result i32)
    (call $websnark_bn128/bn128_ftm_one
      (i32.const 206704))
    (call $bn128_prepareG1
      (local.get $p0)
